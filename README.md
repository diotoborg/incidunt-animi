# node-@diotoborg/incidunt-animi [![NPM version][npm-img]][npm-url]
...
When `@diotoborg/incidunt-animi.replace()` is used with a replacer function, the replacer can return a buffer, or a string. But all arguments
